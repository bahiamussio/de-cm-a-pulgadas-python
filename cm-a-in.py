...
medidas_cm = float(input("Por favior, ingrese las medidas de la pieza en centímetros para convertirla a pulgadas: "))
# Paso 3: Realizar la conversión de centímetros a pulgadas.
medidas_pulgadas = medidas_cm * pulgada

# Paso 4: Mostrarle al usuario las medidas convertidas a in.
